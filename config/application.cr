...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Open Fic web application."
  #
  #
  ...
  #
  # settings.secret_key_base= ID1D01_5tAbNXXdPt4o7r8K3C2Pg0VeV-h6JeDt_8oc
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("open-fic.log", "w"))
  #
  #
end
